...
public class CodeApril {
    ...
    public CodeApril(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (CodeApril) to respond directly to events.
